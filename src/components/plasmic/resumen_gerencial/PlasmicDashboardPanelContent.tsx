    ...
    () => [
      {
        ...
        initFunc: true
          ? ({ $props, $state, $queries, $ctx }) => $props.estado
          : undefined
      }
    ],
    [$props, $ctx]
    ...
    >
      ...
      <TextGroup
        ...
        className={classNames("__wab_instance", sty.textGroup, {
          [sty.textGroupestado_enTermino]: hasVariant(
            $state,
            "estado",
            "enTermino"
          )
      ...
      <TextGroup
        ...
        className={classNames("__wab_instance", sty.total, {
          ...
          [sty.totalestado_enTermino]: hasVariant(
            $state,
            "estado",
            "enTermino"
          ),
      ...
      <TextGroup
        ...
        className={classNames("__wab_instance", sty.capital, {
          [sty.capitalestado_enTermino]: hasVariant(
            $state,
            "estado",
            "enTermino"
          )
